...
func userToOutput(user *entity.User) *dto.UserOutput {
	return &dto.UserOutput{
		...
		ShowFulfilledWishes: user.ShowFulfilledWishes,
...
func (uc *UseCase) UpdateSettings(ctx context.Context, id uuid.UUID, pushNotifications, emailNotifications, showFulfilledWishes *bool) error {
	return uc.userRepo.UpdateSettings(ctx, id, pushNotifications, emailNotifications, showFulfilledWishes)
}
